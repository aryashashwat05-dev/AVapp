...
export default function Home() {
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      ...
      toast({
        title: "Room Created!",
        description: `Your new room code is ${newRoomCode}.`,
      });
  ...
  const handleDeleteRoom = (roomId: string) => {
    ...
    // Note: This does not delete subcollections like 'votes'. 
                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Create a new voting room for your class.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Click the button below to generate a new room with a unique join code.
                            </p>
                        </CardContent>
                        <CardFooter>
    ...
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <main className="flex flex-1 items-center justify-center p-4 md:p-8">
        <div className="mx-auto w-full max-w-md">
            {userProfile || user.isAnonymous ? renderDashboard() : <Loader2 className="mx-auto h-8 w-8 animate-spin text-primary" />}
        </div>
      </main>
    </div>
  );
